        ...
        {slides.map((slide, i) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={cn(
                  "absolute inset-0 z-10 flex h-full flex-col items-center justify-between gap-2 pt-12 text-center",
                  "px-2 sm:gap-3 sm:px-3 sm:pt-14 md:pt-16",
                  "lg:flex-row lg:items-center lg:justify-between lg:gap-0 lg:pt-0 lg:text-left lg:px-6 xl:px-10",
                )}
              >
                <div
                  className={cn(
                    "flex w-full shrink-0 flex-col items-center justify-center",
                    "lg:w-[48%] lg:items-start",
                  )}
                >
                  <motion.p
                    className={cn(
                ...
                <motion.div
                  className={cn(
                    "pointer-events-none flex h-[90%] w-full max-h-[90%] shrink-0 items-end justify-center",
                    "md:h-auto md:max-h-[85%]",
                    "lg:h-full lg:max-h-full lg:min-h-0 lg:w-[48%] lg:flex-1 lg:shrink-0 lg:self-end",
                  )}
                  initial={false}
