...
const depositBoxTitleIconClassName = cn(
    ...
    "after:pointer-events-none after:absolute after:inset-[-2px] after:rounded-2xl after:border after:border-[rgba(255,252,247,0.55)] after:opacity-80 after:content-['']",
    "sm:after:rounded-[24px] lg:after:rounded-[30px]",
    "group-hover/depositMain:-translate-y-1 group-hover/depositMain:scale-[1.04]",
    "group-hover/depositMain:shadow-[0_16px_40px_rgba(184,146,58,0.22)]",
);
                    ...
                    <div className="col-span-12 flex flex-col gap-4 lg:col-span-5 lg:gap-5">
                        ...
                        >
                            <div className="mb-5 flex items-center gap-2.5 text-lg font-extrabold text-[#2c2416] sm:mb-7 sm:gap-3 sm:text-xl">
                                <BsBank2 className="size-5 shrink-0 text-[#8a7344] sm:size-6" />
                                <h2
                            ...
                            >
                                <div className="mb-3 text-base font-extrabold text-[#8a7344] sm:mb-4 sm:text-lg">
                                    {displayBankName}
                                </div>
                                <div className="mb-2.5 break-all text-xl font-extrabold tracking-[-0.5px] text-[#2c2416] sm:mb-3.5 sm:text-2xl sm:tracking-[-1px] lg:text-3xl">
                                    {displayBankAccount}
                                </div>
                                <div className="text-sm text-[#8a7344] sm:text-[15px]">
                        ...
                        >
                            <div className="mb-5 flex items-center gap-2.5 text-lg font-extrabold text-[#2c2416] sm:mb-7 sm:gap-3 sm:text-xl">
                                <BsExclamationCircleFill className="size-5 shrink-0 text-[#8a7344] sm:size-6" />
                                <h2
